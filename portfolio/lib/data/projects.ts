...
export const projects: Project[] = [
  ...
  // },
  {
    ...
    images: ["/projects/automatizacionAtencionAlCliente.png"],
    features: [
  ...
  },
  {
    ...
    client: "Cliente privado",
    images: ["/projects/authservice.png"],
    features: [
  ...
  },
  {
    ...
    images: ["/projects/cafeimg-2.jpeg"],
  ...
  //MOBILE
{
  slug: "getreal-mobile-rebranding",
  title: "GetReal Mobile Rebranding & Product Experience",
  category: "Mobile Development",
  shortDescription:
    "Lideré el rediseño y la implementación del rebranding completo de una aplicación financiera desarrollada con React Native y Expo, definiendo la nueva identidad visual, componentes y experiencia de usuario.",

  description:
    "Proyecto de rebranding y evolución de producto para GetReal, una aplicación financiera mobile. Mi participación incluyó el rediseño de todas las pantallas de la aplicación, la definición de una nueva identidad visual, la creación de un sistema de diseño reutilizable y la implementación completa del rebranding en React Native y Expo.",
  ...
  role: "Full Stack Developer (React Native & Expo Specialist)",

  roleDescription:
    "Responsable del rediseño y la implementación integral del rebranding de la aplicación. Definí la identidad visual, la paleta de colores, los componentes reutilizables y desarrollé las nuevas experiencias mobile utilizando React Native y Expo.",

  duration: "Jun 2026 – Jul 2026",

  client: "GetReal – Jude M. Loza",
  ...
  features: [
    "Rebranding completo de la aplicación mobile",
    "Rediseño de todas las pantallas y flujos principales",
    "Definición de identidad visual y paleta de colores",
    "Creación de Design System y componentes reutilizables",
    "Implementación completa en React Native y Expo",
    "Mejora de la experiencia de usuario y jerarquía visual",
    "Modernización de la interfaz para una experiencia fintech",
  ],

  about:
    "GetReal es una aplicación financiera enfocada en ayudar a sus usuarios a gestionar y entender mejor sus finanzas personales. Mi trabajo consistió en liderar el rediseño integral de la experiencia mobile, creando una nueva identidad visual y desarrollando todas las pantallas bajo una arquitectura de componentes reutilizables en React Native y Expo. El objetivo fue modernizar la aplicación, mejorar la experiencia de usuario y establecer una base sólida y escalable para futuras funcionalidades.",

  built: [
    "Rediseño de todas las pantallas principales de la aplicación",
    "Definición de la nueva identidad visual y sistema de diseño",
    "Creación de paleta de colores, tipografía y componentes reutilizables",
    "Implementación del rebranding completo en React Native y Expo",
    "Refactorización de componentes existentes y mejora de consistencia visual",
    "Desarrollo de nuevas funcionalidades y experiencias mobile",
    "Optimización de la experiencia de usuario y navegación de la aplicación",
  ],
},
  {
  ...
  //GITHUB ACTIONS
  {
    ...
    images: ["/projects/QAAutomation&DevOps.png"],
